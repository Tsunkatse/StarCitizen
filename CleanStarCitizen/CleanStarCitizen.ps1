...
Write-Host "           4.  Delete SHADER folders" -ForegroundColor Yellow 
Write-Host "           5.  DELETE ALL" -ForegroundColor Yellow
...
$CheckActions = Compare-Object -ReferenceObject $Actions -DifferenceObject @(1..5)
...
# Delete LIVE\USER
if ($Actions -contains 1 -or $Actions -contains 5) { 
...
# Delete PTU\USER
if ($Actions -contains 2 -or $Actions -contains 5) { 
...
# Delete EPTU\USER
if ($Actions -contains 3 -or $Actions -contains 5) { 
...
if ($Actions -contains 4 -or $Actions -contains 5) { 
